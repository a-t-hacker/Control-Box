VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} XLLOADING_CTRLBOX 
   ClientHeight    =   1530
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   6810
   OleObjectBlob   =   "XLLOADING_CTRLBOX.frx":0000
   StartUpPosition =   2  'CenterScreen
End
Attribute VB_Name = "XLLOADING_CTRLBOX"
...
'//wait...
Art = "<lib>xbas;delayevent(25);$": Call xlas(Art)

'//close loading window...
If Range("xlasAppLoad").Value = 1 Then XLLOADING_CTRLBOX.Hide
...
XLLOADING_CTRLBOX.BackColor = RGB(R, G, B) '//change background color
X = X + 2 '//amount to increment each load iteration
Art = "<lib>xbas;delayevent(2);$": Call xlas(Art) '//wait...
Next
...
'//wait...
Art = "<lib>xbas;delayevent(2);$": Call xlas(Art)
...
XLLOADING_CTRLBOX.Hide

'//wait...
Art = "<lib>xbas;delayevent(2);$": Call xlas(Art)

'//show refreshed load window
XLLOADING_CTRLBOX.Show
