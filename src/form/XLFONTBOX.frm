...
xWin.Font.Size = FontSizeBox.Value
...
xWin.Font.name = FontStyleBox.Value
...
If xWin.Font.Bold = False Then
xWin.Font.Bold = True
Else
    xWin.Font.Bold = False
        End If
...
'//set font italic
If xWin.Font.Italic = False Then
xWin.Font.Italic = True
Else
    xWin.Font.Italic = False
        End If
...
If xWin.Font.Underline = False Then
xWin.Font.Underline = True
Else
    xWin.Font.Underline = False
        End If
