...
AppInformationBox.Value = CtrlBox_INFO.AppLicense
...
'//start w/ msedge
Art = "<lib>xbas;sh(msedge.exe https://" & "twitter.com/" & xLink & ");$" '//xlas
Call xlas(Art)
...
'//start w/ msedge
Art = "<lib>xbas;sh(msedge.exe https://" & WebsiteLink.Caption & ");$" '//xlas
Call xlas(Art)
